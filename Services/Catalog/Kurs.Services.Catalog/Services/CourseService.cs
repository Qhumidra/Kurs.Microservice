...
namespace Kurs.Services.Catalog.Services
{
    public class CourseService : ICourseService
    {
        ...
        public async Task<Response<NoContent>> UpdateAsync(CourseUpdateDto courseUpdateDto)
        {
            ...
            await _publishEndpoint.Publish<CourseNameChangedEvent>(new CourseNameChangedEvent { UserId = courseUpdateDto.UserId, CourseId = courseUpdateDto.Id, CourseName = courseUpdateDto.Name, Price = courseUpdateDto.Price });
